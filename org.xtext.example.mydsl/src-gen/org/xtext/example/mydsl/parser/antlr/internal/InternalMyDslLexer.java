...
public class InternalMyDslLexer extends Lexer {
	...
	public final void mRULE_FLOAT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalMyDsl.g:400:12: ( ( '-' | '.' | 'e' | RULE_INT )+ )
			// InternalMyDsl.g:400:14: ( '-' | '.' | 'e' | RULE_INT )+
			{
			// InternalMyDsl.g:400:14: ( '-' | '.' | 'e' | RULE_INT )+
			int cnt1=0;
			loop1:
			while (true) {
				...
				switch (alt1) {
				case 1 :
					// InternalMyDsl.g:400:15: '-'
					{
					match('-'); 
					}
					break;
				case 2 :
					// InternalMyDsl.g:400:19: '.'
					{
					match('.'); 
					}
					break;
				case 3 :
					// InternalMyDsl.g:400:23: 'e'
					{
					match('e'); 
					}
					break;
				case 4 :
					// InternalMyDsl.g:400:27: RULE_INT
					{
					mRULE_INT(); 
